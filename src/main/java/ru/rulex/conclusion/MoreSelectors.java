...
public final class MoreSelectors
{
  ...
  public static <T extends Number & Comparable<? super T>, E> NumberSelector<T, E> number(
      Selector<E, T> selector )
  {
  ...
  public static final class NumberSelector<T extends Number & Comparable<? super T>, E> extends
      TypeSafeSelector<E, T>
  {
  ...
  public static final class StringSelector<T> extends TypeSafeSelector<T, String>
  {
  ...
  public static final class OptionalAbsentPath extends TypeSafeSelector<Object, Optional<?>>
  {
    static final OptionalAbsentPath INSTANCE = new OptionalAbsentPath(
        new Selector<Object, Optional<?>>()
        {
          @Override

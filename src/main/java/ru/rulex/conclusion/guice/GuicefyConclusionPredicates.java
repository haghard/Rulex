...
public final class GuicefyConclusionPredicates {
  ...
  public static class GuicefyEqualsConclusionPredicate<T extends Comparable<? super T>>
  ...
  public static class GuicefyLessConclusionPredicate<T extends Comparable<? super T>>
      implements ConclusionPredicate<T> {
    private final T parameter;
  ...
  public static class GuicefyMoreConclusionPredicate<T extends Comparable<? super T>>
      implements ConclusionPredicate<T> {
    private final T parameter;
  ...
  public static class GuicefyAnyOffConclusionPredicate<T>
      implements ConclusionPredicate<T> {
